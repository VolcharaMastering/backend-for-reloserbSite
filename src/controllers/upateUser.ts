...
const updateUser: forFunction = async (req, res, next) => {
  ...
  if (
    ...
    (requestBody.phoneNumber !== undefined &&
      typeof requestBody.phoneNumber !== "string") ||
    (requestBody.tgLink !== undefined &&
      typeof requestBody.tgLink !== "string") ||
    (requestBody.interestProjects !== undefined &&
      !Array.isArray(requestBody.interestProjects)) ||
    (requestBody.sendRequests !== undefined &&
      !Array.isArray(requestBody.sendRequests)) ||
    (requestBody.businessData !== undefined &&
